...
/**
 * SearchBar — used on HomePage hero + ResultsPage header
 * Props:
 *   placeholder: string
 *   compact: boolean — smaller variant for ResultsPage header
 *   onGeoClick: fn — trigger geolocation search
 */
export default function SearchBar({
  ...
  /* Auto-navigate while typing */
  useEffect(() => {
    if (debounced.trim().length >= 2) {
      navigate(`/results?q=${encodeURIComponent(debounced)}`, { replace: true })
    }
  }, [debounced, navigate])
  ...
  /* Geolocation — navigate with coords */
  function handleGeo() {
    ...
    >
      ...
      <button
        ...
        className="
          ...
          shadow-teal hover:brightness-105
